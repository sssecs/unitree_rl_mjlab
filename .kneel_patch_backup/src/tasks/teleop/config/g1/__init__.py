...
from .kneel_env_cfg import (
  unitree_g1_teleop_kneel_acquire_env_cfg,
  unitree_g1_teleop_kneel_acquire_home_env_cfg,
...
register_mjlab_task(
  task_id="Unitree-G1-Teleop-Kneel-Acquire",
  env_cfg=unitree_g1_teleop_kneel_acquire_env_cfg(),
  play_env_cfg=unitree_g1_teleop_kneel_acquire_env_cfg(play=True),
  rl_cfg=unitree_g1_teleop_ppo_runner_cfg(),
  runner_cls=TeleopOnPolicyRunner,
)

register_mjlab_task(
  task_id="Unitree-G1-Teleop-Kneel-Acquire-Home",
  env_cfg=unitree_g1_teleop_kneel_acquire_home_env_cfg(),
  play_env_cfg=unitree_g1_teleop_kneel_acquire_home_env_cfg(play=True),
  rl_cfg=unitree_g1_teleop_ppo_runner_cfg(),
  runner_cls=TeleopOnPolicyRunner,
)
